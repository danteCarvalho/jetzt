...
(function (C) {
    ...
    function Fe() {
        ...
        if (!Wc) {
            var b = qb();
            (rb = z(b) ? C.jQuery : b ? C[b] : void 0) && rb.fn.on ? ((x = rb), S(rb.fn, { scope: Wa.scope, isolateScope: Wa.isolateScope, controller: Wa.controller, injector: Wa.injector, inheritedData: Wa.inheritedData })) : (x = Y);
            a = x.cleanData;
    ...
    function Ag(a, b, d, c, e) {
        ...
        h.url = function (b, d, e) {
            ...
            if (b) {
                ...
                N = e;
                !c.history || (k && f)
                    ? (k || (qa = b), d ? l.replace(b) : k ? ((d = l), (e = b), (f = e.indexOf("#")), (e = -1 === f ? "" : e.substr(f)), (d.hash = e)) : (l.href = b), l.href !== b && (qa = b))
            ...
            function (a, b, c, e, p, M, L, u, R) {
                ...
                function aa(a, b, d, e, f, g, h, k, l) {
                    ...
                    function p(a, e, f, g, l) {
                        ...
                        n = 0;
                        for (u = h.length; n < u; n++) (L = h[n]), Ba(L, L.isolateScope ? y : e, Q, g, L.require && W(L.directiveName, L.require, Q, P), M);
                        var R = e;
    ...
    function Nf() {
        var a = (this.defaults = {
                ...
                headers: { common: { Accept: "application/json, text/plain, */*" }, post: ja(wc), put: ja(wc), patch: ja(wc) },
        ...
        this.$get = [
            ...
            function (e, f, g, k, h, l, m, p) {
                ...
                function s(c, d) {
                    ...
                    z(q) &&
                        ((q = jc(c.url) ? g()[c.xsrfCookieName || a.xsrfCookieName] : void 0) && (ma[c.xsrfHeaderName || a.xsrfHeaderName] = q),
                                            ...
                                            if ((a = n[n.$$digestWatchIndex]))
                                                if (((m = a.get), (g = m(q)) !== (h = a.last) && !(a.eq ? va(g, h) : X(g) && X(h))))
                                                    (s = !0),
                                                        ...
                                                        (l = a.fn),
                                                        l(g, h === G ? g : h, q),
                                                        5 > r && ((z = 4 - r), N[z] || (N[z] = []), N[z].push({ msg: B(a.exp) ? "fn: " + (a.exp.name || a.exp.toString()) : a.exp, newVal: g, oldVal: h }));
                                                else if (a === c) {
                                                    s = !1;
                                                    break a;
                                                }
        ...
        this.$get = [
            ...
            function (d, c) {
                function e(a, b) {
                    var c;
                    "self" === a
                        ? (c = Bc(b, Od)) || (C.document.baseURI ? (c = C.document.baseURI) : (Na || ((Na = C.document.createElement("a")), (Na.href = "."), (Na = Na.cloneNode(!1))), (c = Na.href)), (c = Bc(b, c)))
                        : (c = !!a.exec(b.href));
                    return c;
                }
                function f(a) {
    ...
    function Pd(a) {
        ...
        return function () {
            ...
            if (a !== e) for (e = a, a = e.split("; "), c = {}, k = 0; k < a.length; k++) (g = a[k]), (h = g.indexOf("=")), 0 < h && ((l = b(g.substring(0, h))), z(c[l]) && (c[l] = b(g.substring(h + 1))));
            return c;
        };
    }
    function kg() {
        ...
        Aa = function () {
            if (!w(Aa.rules)) {
                ...
                if (a) {
                    ...
                    Aa.rules = { noUnsafeEval: !b || -1 !== b.indexOf("no-unsafe-eval"), noInlineStyle: !b || -1 !== b.indexOf("no-inline-style") };
                } else {
                    a = Aa;
                    try {
                        new Function(""), (b = !1);
    ...
    var Ea = F("$sce"),
        V = { HTML: "html", CSS: "css", MEDIA_URL: "mediaUrl", URL: "url", RESOURCE_URL: "resourceUrl", JS: "js" },
        Cc = /_([a-z])/g,
