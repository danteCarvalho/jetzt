...
!(function (a) {
    ...
    (function (a) {
        ...
        function c(a, b) {
            ...
            var e = a[d];
            return "Object" !== f.realTypeOf(e) ? void console.warn("config lookup: no key '" + d + "'") : c(e, b.slice(1));
        }
        function d(a, b, c) {
            if (0 === b.length) throw new Error("No keys specified.");
            var d = b[0];
            if (1 === b.length) a[d] = c;
                ...
                var e = a[d];
                "Object" !== f.realTypeOf(e) && ((e = {}), (a[d] = e)), _put(e, b.slice(1), c);
            }
        }
        var e = a.jetzt,
            f = e.helpers;
        ...
        (e.config = function (a, e) {
            return "string" == typeof a && (a = [a]), 1 === arguments.length ? c(g, a) : (d(g, a, e), i.set(g), b(), void 0);
        }),
            (e.config.setBackend = function (a) {
                (i = a),
                    a.get(function (a) {
                        if ("Object" !== f.realTypeOf(a)) throw new Error("bad config backend");
    ...
    (function (a) {
        ...
        function e() {
            ...
            this.spacer = function () {
                f ? (f.modifier = "long_space") : (f = g({ token: "   ", modifier: "short_space" }));
            };
            var h = function (b) {
                f && a.push(f), a.push(g({ token: b, modifier: c })), (c = "normal"), (f = null);
            };
        ...
        function f(a, b) {
            for (var c = b ? b : new e(), d = null, h = 0; h < a.childNodes.length; h++)
        ...
        function g(a, b) {
            for (var c = a.match(/["“”\(\)\/–—]|--+|\n+|[^\s"“”\(\)\/–—]+/g), d = b ? b : new e(), f = !1, g = 0; g < c.length; g++) {
                ...
                switch (h) {
                    ...
                    default:
                        h.match(/^(\/|--+|—|–)$/)
                            ? (d.modNext("start_clause"), d.token(h), d.modNext("start_clause"))
                            : h.match(/[.?!…]+$/)
                            ? (d.modNext("end_sentence"), d.token(h), d.modNext("start_sentence"))
                            : h.match(/[,;:]$/)
                            ? (d.modNext("end_clause"), d.token(h), d.modNext("start_clause"))
                            : h.match(/\n+/)
                            ? (h.length > 1 || (g > 0 && c[g - 1].match(/[.?!…'"”]+$/))) && (d.clearWrap(), d.modPrev("end_paragraph"), d.spacer(), d.modNext("start_paragraph"), (f = !1))
                            : h.match(/^".+$/)
        ...
        var i = a.jetzt,
            j = i.helpers,
            k = i.config,
            l = { double_quote: { left: "“", right: "”" }, parens: { left: "(", right: ")" }, heading1: { left: "H1", right: "" } };
        i.parse = {
            string: function (a) {
                return h(g, a);
            },
        ...
        function c() {
            ...
            (this.onBackdropClick = function (a) {
                ...
                (this.applyConfig = function () {
                    console.log("yesss"), this.setScale(e("scale")), this.setWPM(e("target_wpm")), this.setFont(e(["view", "font_family"])), e("show_message") ? this.showMessage() : this.hideMessage(), this.setTheme(e("dark"));
                }),
                (this.show = function (b) {
                    document.body.appendChild(d), d.offsetWidth, f.addClass(d, "in"), document.body.appendChild(u), u.offsetWidth, f.addClass(u, "in"), this.applyConfig();
                    var g = this;
                    c = e.onChange(function () {
                        g.applyConfig();
                    });
                    var h = f.getScrollTop();
                    v(), (document.body.scrollTop = h), (document.documentElement.scrollTop = h), (s.onblur = v), "function" == typeof b && a.setTimeout(b, 340);
                }),
                ...
                (this.setScale = function (a) {
                    (u.style.webkitTransform = "translate(-50%, -50%) scale(" + a + ")"), (u.style.mozTransform = "translate(-50%, -50%) scale(" + a + ")"), (u.style.transform = "translate(-50%, -50%) scale(" + a + ")");
                }),
                ...
                (this.setWrap = function (a, b) {
                    ...
                    var c = j.offsetWidth,
                        d = k.offsetWidth;
                    (u.style.paddingLeft = "50px"), (u.style.paddingRight = "50px"), c > d ? (u.style.paddingRight = 50 + (c - d) + "px") : d > c && (u.style.paddingLeft = 50 + (d - c) + "px");
                }),
                (this.clear = function () {
    ...
    (function (a) {
        ...
        function d() {
            var a = [],
                ...
                i = { DIV: !0, ARTICLE: !0, BLOCKQUOTE: !0, MAIN: !0, SECTION: !0, UL: !0, OL: !0, DL: !0 },
                j = { P: !0, H1: !0, H2: !0, H3: !0, H4: !0, H5: !0, H6: !0, SPAN: !0, DL: !0, OL: !0, UL: !0, BLOCKQUOTE: !0, SECTION: !0 },
                k = function (a) {
        ...
        e.select = function () {
            ...
            b.trim().length > 0 ? (e.init(e.parse.string(b)), a.getSelection().removeAllRanges()) : d();
        };
    })(this),
    (function (a) {
        function b(a) {
